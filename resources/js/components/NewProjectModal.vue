  	...
  	<modal name="new-project-modal" classes="p-10 bg-card rounded-lg" height="auto">
		...
		<form @submit.prevent="submit">
				...
				<div class="flex-1 mr-4">
					<div class="mb-4">
						...
						<input 
							...
							name="title" 
							id="title" 
							class="border border-solid border-muted-light p-2 text-xs block w-full rounded" 
							v-model="form.title"
							required>
					</div>
					<div class="mb-4">
			...
			<footer class="flex justify-end">
				<button type="button" class="button mr-4 is-outlined" @click.prevent="$modal.hide('new-project-modal')">Cancel</button>
